  ...
  return (
    <div className='flex justify-between 
     gap-3 md:gap-2 items-center p-6 '>
      ...
      <button className='font-semibold px-6 py-3 hover:bg-gray-300
         rounded-full text-[20px]'
        onClick={() => onCreateClick()}>Create</button>
      <div className='bg-[#e9e9e9] py-2 px-6
         gap-3 items-center rounded-full w-full hidden md:flex'>
        <HiSearch className='text-[30px] 
        text-gray-500'/>
      ...
      {session?.user ?
        ...
        <button className='font-semibold p-2 px-4 rounded-full hover:text-red-600 hover:bg-gray-300 text-lg'
